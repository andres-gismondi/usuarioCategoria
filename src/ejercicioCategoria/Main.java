...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        Empresa despegar = new Empresa("Despegar",10000);
        ...
        Usuario andres = new Usuario("Andres", "Gismondi", 8000, 1, despegar, tr);
        Usuario andres1 = new Usuario("Andres1", "Gismondi1", 10000, 2, despegar, jr);
        Usuario andres2 = new Usuario("Andres2", "Gismondi2", 8500, 3, despegar, ssr);
        Usuario andres3 = new Usuario("Andres3", "Gismondi3", 9000, 6, despegar, sr);
        Usuario andres4 = new Usuario("Andres4", "Gismondi4", 9500, 7, despegar, director );
